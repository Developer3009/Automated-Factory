...
async function ensureDatabase() {
    ...
    `);
        const insertIfEmpty = async (tableName, queryString) => {
...
app.get('/api/ai-insight', async (_req, res) => {
    const insight = await askOllama('You are a factory operations AI. Give a concise insight covering machine health, supplier risk, inventory pressure, and the next best action for an industrial dashboard.');
    res.json({ insight });
});
